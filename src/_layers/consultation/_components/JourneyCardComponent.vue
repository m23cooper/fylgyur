...
<template>
    <div id="JourneyCardComponent" class="card rounded-lg bg-base-100 w-full shadow-xl min-h-24 cursor-pointer hover:bg-base-300">
...
<script setup lang="ts">
  ...
  const props: Readonly<IJourneyCardComponentProps> = withDefaults(defineProps<IJourneyCardComponentProps>(), {
    form: null,
  });
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PRIVATE
  const _name: string = "JourneyCardComponent";
