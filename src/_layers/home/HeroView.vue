...
<template>
  <div class="container relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Your Portfolio Pathfinder /</h2>
      <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">Founders Mentor App</h2>
      <p class="mt-6 text-lg leading-8 text-gray-300">This pathfinder is designed to help you think, ‘unpack’ your ideas, and create an authentic and personal business hypothesis.</p>
    </div>
  </div>
</template>
...
<script setup lang="ts">
  ...
  // }
  //
  // const props: Readonly<IHeroViewProps> = withDefaults(defineProps<IHeroViewProps>(), {
  //   blah: "",
  // });
  ...
  onMounted(() => {
    let test = 0;
    console.log(`HeroView onMounted!`);
    // _store.init();
  })

  // onUpdated(() => {
  //   console.log(`HeroView onUpdated!`);
  // })

  // onUnmounted(() => {
  //   console.log(`HeroView unmounted!`);
  // })
