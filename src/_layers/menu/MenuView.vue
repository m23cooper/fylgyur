...
<template>
  <div class="w-[4rem] flex flex-col h-full bg-slate-800/75 overflow-hidden">
    ...
    <div v-if="useUserStore().isDevUser" class="flex flex-shrink ">
      <div @click="onDevClick" class="cursor-pointer flex items-center w-[3rem] h-[3rem] m-2 text-white bg-red-700 rounded-lg hover:scale-110 transition">
        <FontIconComponent
    ...
    <div class="flex flex-shrink ">
      <div @click="onLogoutClick" class="cursor-pointer flex items-center w-[3rem] h-[3rem] m-2 text-white bg-red-700 rounded-lg hover:scale-110 transition">
        <FontIconComponent
