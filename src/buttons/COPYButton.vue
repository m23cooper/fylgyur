...
<script setup lang="ts">
  ...
  const props: Readonly<ICOPYButtonComponentProps> = withDefaults(defineProps<ICOPYButtonComponentProps>(), {
    fontIconSize: FontIconSize.LG
  });

  const _name: string = "COPYButton";
