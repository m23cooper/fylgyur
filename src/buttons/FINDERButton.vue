...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface IFINDERButtonProps {
    fontIconSize?: string;
  }

  const props: Readonly<IFINDERButtonProps> = withDefaults(
    defineProps<IFINDERButtonProps>(),
    {
      fontIconSize: FontIconSize.LG,
    }
  );

  const _name: string = 'FINDERButton';
