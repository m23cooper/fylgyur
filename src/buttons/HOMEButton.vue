...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface IHOMEButtonComponentProps
  {
    fontIconSize?: string;
  }

  const props: Readonly<IHOMEButtonComponentProps> = withDefaults(defineProps<IHOMEButtonComponentProps>(), {
    fontIconSize: FontIconSize.LG
  });

  const _name: string = "HOMEButton";
