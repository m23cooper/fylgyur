...
<template>
  <div
    class="btn btn-primary hover:scale-110 transition"
...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface IADDButtonComponentProps {
    fontIconSize?: string;
  }

  const props: Readonly<IADDButtonComponentProps> = withDefaults(
    defineProps<IADDButtonComponentProps>(),
    {
      fontIconSize: FontIconSize.LG,
    }
  );

  const _name: string = 'ADDButton';
