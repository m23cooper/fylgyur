...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface ILOGOUTButtonComponentProps
  {
    fontIconSize?: string;
  }

  const props: Readonly<ILOGOUTButtonComponentProps> = withDefaults(defineProps<ILOGOUTButtonComponentProps>(), {
    fontIconSize: FontIconSize.LG
  });

  const _name: string = "LOGOUTButton";
