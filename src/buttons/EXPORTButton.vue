...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface IEXPORTButtonComponentProps {
    fontIconSize?: string;
  }

  const props: Readonly<IEXPORTButtonComponentProps> = withDefaults(
    defineProps<IEXPORTButtonComponentProps>(),
    {
      fontIconSize: FontIconSize.LG,
    }
  );

  const _name: string = 'EXPORTButton';
