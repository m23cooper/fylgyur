...
<template>
  <div class="btn btn-warning drop-shadow-lg hover:scale-110 transition" @click.stop="emit(EMIT.CLICK)">
    <FontIconComponent
        :icon-type="FontIconType.WARNING"
...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface IWARNINGButtonComponentProps
  {
    fontIconSize?: string;
  }

  const props: Readonly<IWARNINGButtonComponentProps> = withDefaults(defineProps<IWARNINGButtonComponentProps>(), {
    fontIconSize: FontIconSize.LG
  });

  const _name: string = "WARNINGButton";
