...
<template>
  <div class="btn hover:scale-110 transition" @click.stop="emit(EMIT.CLICK)">
    <FontIconComponent
        :icon-type="FontIconType.DOWNLOAD"
...
<script setup lang="ts">
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////
  //  PROPS
  interface IDOWNLOADButtonComponentProps
  {
    fontIconSize?: string;
  }

  const props: Readonly<IDOWNLOADButtonComponentProps> = withDefaults(defineProps<IDOWNLOADButtonComponentProps>(), {
    fontIconSize: FontIconSize.LG
  });

  const _name: string = "DOWNLOADButton";
